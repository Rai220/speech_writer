...
_Эта вводная статья была опубликована в 2014 году основателем [Ethereum](/ru/what-is-ethereum/) Виталиком Бутериным, до запуска проекта в 2015 году. Стоит отметить, что Ethereum, как и многие проекты с открытым исходным кодом, со временем эволюционировал._

_Несмотря на то что этой статье уже несколько лет, мы не удаляем ее, потому что она продолжает служить полезным источником, содержащим точную информацию об Ethereum и его видении. Чтобы узнать о нововведениях в Ethereum и о внесении изменений в протокол, рекомендуем ознакомиться с [этим руководством](/ru/learn/)._

[Этот PDF предназначен для исследователей и ученых, которым нужна историческая или каноническая версия проектного документа \[от декабря 2014 года\].](/content/whitepaper/whitepaper-pdf/Ethereum_Whitepaper_-_Buterin_2014.pdf)

## [a next generation smart contract and decentralized application platform permalink](\#a-next-generation-smart-contract-and-decentralized-application-platform) Платформа следующего поколения для смарт-контрактов и децентрализованных приложений

Создание биткоина в 2009 году Сатоши Накамото часто называется радикальной разработкой в деньгах и валюте, являясь первым примером цифрового актива, который одновременно не имеет основы или [внутренней ценности(opens in a new tab)](http://bitcoinmagazine.com/8640/an-exploration-of-intrinsic-value-what-it-is-why-bitcoin-doesnt-have-it-and-why-bitcoin-does-have-it/) и не имеет централизованного эмитента или контроллера. Тем не менее другой, возможно, более важной, частью эксперимента является базовая технология блокчейн как инструмент распределенного консенсуса, и внимание быстро начинает смещаться к этому аспекту биткоина. Часто упоминаемые альтернативные приложения технологии блокчейн включают использование цифровых активов на блокчейне для представления пользовательских валют и финансовых инструментов ( [цветных монет(opens in a new tab)](https://docs.google.com/a/buterin.com/document/d/1AnkP_cVZTCMLIzw4DvsW6M8Q2JC0lIzrTLuoWu2z1BE/edit)), право собственности на лежащее в основе физическое устройство ( [смарт-объект(opens in a new tab)](https://en.bitcoin.it/wiki/Smart_Property)), невзаимозаменяемые активы, такие как доменные имена ( [Namecoin(opens in a new tab)](http://namecoin.org)), а также более сложные приложения, в которых цифровые активы напрямую контролируются частью кода, реализующей произвольные правила ( [смарт-контракты(opens in a new tab)](http://www.fon.hum.uva.nl/rob/Courses/InformationInSpeech/CDROM/Literature/LOTwinterschool2006/szabo.best.vwh.net/idea.html)) или даже основанные на блокчейне [децентрализованные автономные организации(opens in a new tab)](http://bitcoinmagazine.com/7050/bootstrapping-a-decentralized-autonomous-corporation-part-i/) (DAO). То, что Ethereum планирует предоставить — это блокчейн со встроенным полным по Тьюрингу языком программирования, который может быть использован для создания контрактов, которые можно использовать для кодирования произвольных функций перехода состояния, позволяя пользователям создавать любые из систем, описанных выше, как и многие другие, которые мы еще даже не придумали, просто записав логику в нескольких строках кода.

## [introduction to bitcoin and existing concepts permalink](\#introduction-to-bitcoin-and-existing-concepts) Введение в Bitcoin и существующие концепции

### [history permalink](\#history) История

Концепция децентрализованной цифровой валюты, как и альтернативные приложения, такие как реестры собственности, существует уже несколько десятилетий. Протоколы анонимных электронных платежей 1980-х и 1990-х годов, в основном опирающиеся на криптографический примитив, известный как ослепление Чаума, обеспечивали высокую степень конфиденциальности валюты, но протоколы в значительной степени не смогли завоевать популярность из-за их зависимости от централизованного посредника. В 1998 году [b-money(opens in a new tab)](http://www.weidai.com/bmoney.txt) Вэя Дая стали первым предложением, вводящим идею создания денег путем решения вычислительных головоломок, а также децентрализованного консенсуса, но в предложении было недостаточно информации о том, как реализовать децентрализованный консенсус. В 2005 году Хэл Финни представил концепцию [многоразовых доказательств выполнения работы(opens in a new tab)](https://nakamotoinstitute.org/finney/rpow/), систему, которая использовала идеи b-money и вычислительно сложные Hashcash головоломки Адама Бэка для создания концепции криптовалюты, но в очередной раз не дотянула до идеала, положившись на доверенные вычисления в качестве бэкенда. В 2009 году децентрализованная валюта была впервые реализована на практике Сатоши Накамото, сочетающая сложившиеся примитивы для управления правом собственности (криптография с открытым ключом) с алгоритмом консенсуса для отслеживания владельцев монет, известным как «доказательство выполнения работы».
...
### [bitcoin as a state transition system permalink](\#bitcoin-as-a-state-transition-system) Биткоин как система с изменяющимися состояниями

[![Смена состояния Ethereum](/_next/image/?url=%2Fcontent%2Fwhitepaper%2Fethereum-state-transition.png&w=1920&q=75)](/content/whitepaper/ethereum-state-transition.png)
...
2. Если сумма номиналов всех вводимых UTXO меньше суммы номиналов всех выводимых UTXO, вернуть сообщение об ошибке.
3. Вернуть `S`, где удалены все UTXO ввода и добавлены все UTXO вывода.
...
### [mining permalink](\#mining) Майнинг

[![Блоки Ethereum](/_next/image/?url=%2Fcontent%2Fwhitepaper%2Fethereum-blocks.png&w=1920&q=75)](/content/whitepaper/ethereum-blocks.png)
...
2. Проверить, что временная метка блока больше, чем временная метка предыдущего блока[fn2](#notes) и прошло менее 2 часов с момента создания предыдущего блока
...
### [merkle trees permalink](\#merkle-trees) Деревья Меркла

[![SPV в биткоине](/_next/image/?url=%2Fcontent%2Fwhitepaper%2Fspv-bitcoin.png&w=1920&q=75)](/content/whitepaper/spv-bitcoin.png)
...
### [scripting permalink](\#scripting) Сценарии
...
## [ethereum permalink](\#ethereum) Ethereum
...
### [ethereum accounts permalink](\#ethereum-accounts) Счета Ethereum
...
### [messages and transactions permalink](\#messages-and-transactions) Сообщения и транзакции
...
### [messages permalink](\#messages) Сообщения
...
### [ethereum state transition function permalink](\#ethereum-state-transition-function) Функция смены состояния Ethereum

[![Смена состояния эфира](/_next/image/?url=%2Fcontent%2Fwhitepaper%2Fether-state-transition.png&w=1920&q=75)](/content/whitepaper/ether-state-transition.png)
...
### [code execution permalink](\#code-execution) Исполнение кода
...
### [blockchain and mining permalink](\#blockchain-and-mining) Блокчейн и майнинг

[![Диаграмма применения блоков в Ethereum](/_next/image/?url=%2Fcontent%2Fwhitepaper%2Fethereum-apply-block-diagram.png&w=1920&q=75)](/content/whitepaper/ethereum-apply-block-diagram.png)
...
## [applications permalink](\#applications) Применения
...
### [token systems permalink](\#token-systems) Системы токенов
...
### [financial derivatives and stable value currencies permalink](\#financial-derivatives-and-stable-value-currencies) Производные финансовые инструменты и валюты со стабильной стоимостью
...
### [decentralized file storage permalink](\#decentralized-file-storage) Децентрализованное хранилище файлов
...
### [decentralized autonomous organizations permalink](\#decentralized-autonomous-organizations) Децентрализованные автономные организации
...
Контракт будет содержать положения для каждого из этих типов. Он будет вести учет всех общедоступных изменений хранилища, вместе со списком тех, кто за них голосовал. Он также будет иметь список всех членов. Когда любое изменение хранилища получает голоса двух третей членов, завершающая транзакция может осуществить это изменение. Более сложная конструкция также имела бы встроенную возможность голосования для таких функций, как отправка транзакции, добавление членов и удаление членов, и могла бы даже обеспечить делегирование голосов в стиле [Ликвидной Демократии(opens in a new tab)](https://wikipedia.org/wiki/Liquid_democracy) (т.е. когда любой может назначить кого-то голосовать вместо него, и назначение является транзитивным, поэтому если А назначает В, а В назначает С, тогда С определяет голос А). Такой дизайн позволил бы DAO органично расти как децентрализованное сообщество, позволяя людям в конечном итоге делегировать задачу проверки членов специалистам, хотя в отличие от «текущей системы» специалисты могут легко появляться и исчезать со временем, по мере того, как отдельные члены сообщества меняют свои позиции.
...
### [further applications permalink](\#further-applications) Дополнительные применения
...
### [computation and turing completeness permalink](\#computation-and-turing-completeness) Вычисление и полнота по Тьюрингу
...
### [currency and issuance permalink](\#currency-and-issuance) Валюта и выпуск
...
#### [%D0%B4%D0%BE%D0%BB%D0%B3%D0%BE%D1%81%D1%80%D0%BE%D1%87%D0%BD%D1%8B%D0%B9 %D1%80%D0%BE%D1%81%D1%82 %D0%BF%D1%80%D0%B5%D0%B4%D0%BB%D0%BE%D0%B6%D0%B5%D0%BD%D0%B8%D1%8F (%D0%B2 %D0%BF%D1%80%D0%BE%D1%86%D0%B5%D0%BD%D1%82%D0%B0%D1%85) permalink](\#%D0%B4%D0%BE%D0%BB%D0%B3%D0%BE%D1%81%D1%80%D0%BE%D1%87%D0%BD%D1%8B%D0%B9-%D1%80%D0%BE%D1%81%D1%82-%D0%BF%D1%80%D0%B5%D0%B4%D0%BB%D0%BE%D0%B6%D0%B5%D0%BD%D0%B8%D1%8F-(%D0%B2-%D0%BF%D1%80%D0%BE%D1%86%D0%B5%D0%BD%D1%82%D0%B0%D1%85)) Долгосрочный рост предложения (в процентах)

[![Инфляция Ethereum](/_next/image/?url=%2Fcontent%2Fwhitepaper%2Fethereum-inflation.png&w=1920&q=75)](/content/whitepaper/ethereum-inflation.png)
...
### [mining centralization permalink](\#mining-centralization) Централизация майнинга
...
### [scalability permalink](\#scalability) Масштабируемость
...
## [conclusion permalink](\#conclusion) Заключение
...
## [notes and further reading permalink](\#notes-and-further-reading) Примечания и дополнительная литература

### [notes permalink](\#notes) Примечания
...
### [further reading permalink](\#further-reading) Дальнейшее изучение

01. [Внутренняя ценность(opens in a new tab)](http://bitcoinmagazine.com/8640/an-exploration-of-intrinsic-value-what-it-is-why-bitcoin-doesnt-have-it-and-why-bitcoin-does-have-it/)
02. [Умное имущество(opens in a new tab)](https://en.bitcoin.it/wiki/Smart_Property)
03. [Умные контракты(opens in a new tab)](https://en.bitcoin.it/wiki/Contracts)
04. [B-money(opens in a new tab)](http://www.weidai.com/bmoney.txt)
05. [Многоразовые доказательства выполнения работы(opens in a new tab)](https://nakamotoinstitute.org/finney/rpow/)
06. [Безопасные права на имущество с полномочиями владельца(opens in a new tab)](https://nakamotoinstitute.org/secure-property-titles/)
07. [Проектный документ биткоина(opens in a new tab)](http://bitcoin.org/bitcoin.pdf)
08. [Namecoin(opens in a new tab)](https://namecoin.org/)
09. [Треугольник Zooko(opens in a new tab)](https://wikipedia.org/wiki/Zooko's_triangle)
10. [Проектный документ цветных монет(opens in a new tab)](https://docs.google.com/a/buterin.com/document/d/1AnkP_cVZTCMLIzw4DvsW6M8Q2JC0lIzrTLuoWu2z1BE/edit)
11. [Проектный документ Mastercoin(opens in a new tab)](https://github.com/mastercoin-MSC/spec)
12. [Децентрализованные автономные корпорации, Bitcoin Magazine(opens in a new tab)](http://bitcoinmagazine.com/7050/bootstrapping-a-decentralized-autonomous-corporation-part-i/)
13. [Упрощенная проверка платежей(opens in a new tab)](https://en.bitcoin.it/wiki/Scalability#Simplified_payment_verification)
14. [Деревья Меркла(opens in a new tab)](https://wikipedia.org/wiki/Merkle_tree)
15. [Деревья Патриции(opens in a new tab)](https://wikipedia.org/wiki/Patricia_tree)
16. [GHOST(opens in a new tab)](https://eprint.iacr.org/2013/881.pdf)
17. [StorJ и автономные агенты, Джефф Гарзик(opens in a new tab)](http://garzikrants.blogspot.ca/2013/01/storj-and-bitcoin-autonomous-agents.html)
18. [Майк Херн об умном имуществе на фестивале Тьюринга(opens in a new tab)](https://www.youtube.com/watch?v=MVyv4t0OKe4)
19. [Ethereum RLP(opens in a new tab)](https://github.com/ethereum/wiki/wiki/%5BEnglish%5D-RLP)
20. [Деревья Меркла-Патриции в Ethereum(opens in a new tab)](https://github.com/ethereum/wiki/wiki/%5BEnglish%5D-Patricia-Tree)
21. [Питер Тодд о суммируемых деревьях Меркла(opens in a new tab)](https://web.archive.org/web/20140623061815/http://sourceforge.net/p/bitcoin/mailman/message/31709140/)

_Историю проектного документа смотрите в [этой статье(opens in a new tab)](https://github.com/ethereum/wiki/blob/old-before-deleting-all-files-go-to-wiki-wiki-instead/old-whitepaper-for-historical-reference.md)._

_Ethereum, как и многие проекты с открытым исходным кодом, управляемые сообществом, эволюционировал с момента своего создания. Чтобы узнать о последних событиях в Ethereum, и как внесены изменения в протокол, мы рекомендуем [это руководство](/ru/learn/)._
